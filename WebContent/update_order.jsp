...
<section id="body1">
<h3 style="text-align:center; padding:15px 0;">주문정보 수정</h3>
...
<td colspan=4 align=center style="height:30px;">
	<input id="b1" type="button" value="목록" onclick="location.href='select_order.jsp'">
...
<script>
function check(){
	form.action="update_order_process.jsp";
}
</script>
</html>